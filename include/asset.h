...
/**
 *checks if a coordinate, x and y is in the bounding box
 @param bounding_box bounding box to check
 @param x the x poistion of the mouse click
 @param y the y position of the mouse click
 */
bool in_bounding_box(SDL_Rect bounding_box, double x, double y);

/**
 *gets the body object of an asset
...
/**
 *changes the text of an asset of type text_asset
 @param asset asset to check
 @param text new text to change to
 */
void asset_change_text(asset_t *asset, char *text);

/**
 *changes the texture filepath within asset
 @param asset asset to check
 @param filepath new file path to change to
 */
